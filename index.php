        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="about-col">
              ...
              <p>
              Promover el desarrollo sostenible de la región, por medio de los pequeños y medianos micro-empresarios rurales, desarrollando iniciativas que posibiliten los encadenamientos y la complementariedad productividad que estén en armonía con el medio ambiente, la participación democrática y con enfoque de género.</p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="about-col">
              ...
              <p>
              Ser una organización líder, sólida y sostenible y con el compromiso de sus asociados y clientes en la promoción del desarrollo social de los pequeños y medianos productores y empresarios rurales de la región, por medio del desarrollo de servicios de créditos, capacitación y asistencia técnica y mercadeo.</p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contáctenos</h4>
            <p>
            200 metros este de la Municipalidad de Hojancha <br>
              Hojancha, Guanacaste<br>
              Costa Rica <br>
              <strong>Teléfono:</strong> +506 8855 7250<br>
              <strong>Email:</strong> cemprodeca@gmail.com<br>
            </p>
